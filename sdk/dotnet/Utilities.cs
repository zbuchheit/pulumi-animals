...
namespace Pulumi.Animals
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Animals.version.txt");
    ...
    internal sealed class AnimalsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AnimalsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
